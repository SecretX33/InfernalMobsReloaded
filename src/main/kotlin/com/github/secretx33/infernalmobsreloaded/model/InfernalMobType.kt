...
data class InfernalMobType (
    ...
    init {
        ...
        require(type.entityClass != null) { "type.entityClass cannot be null" }
        require(type.entityClass !is ComplexLivingEntity) { "type.entityClass cannot be a ComplexLivingEntity" }
